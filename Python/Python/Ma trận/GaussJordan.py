...
class Gauss_Jordan_Algorithms:
    ...
    matrix = np.loadtxt("matrix_input.txt")  # Đọc ma trận input từ file
    ...
    def solutions_checker(self):
        ...
        A = np.loadtxt("matrix_input.txt")[:, :-1]  # ma trận hệ số trong phương trình AX=B
        print()
    ...
    def display_solutions(self):
        """Ghi kết quả vào ma trận result, in ma trận result ra màn hình và xuất ra file matrix_output.txt"""
        ...
        # Xuất kết quả ra file matrix_output.txt
        np.savetxt('matrix_output.txt', self.result, fmt='%.5f')  # %.5f: lấy 5 chữ số sau dấu phẩy ghi vào file
